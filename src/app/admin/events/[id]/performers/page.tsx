...
import { FaSearch, FaEdit, FaTrashAlt, FaUpload, FaImages, FaUnlink, FaTicketAlt, FaPercent, FaMicrophone, FaAddressBook, FaHandshake, FaEnvelope, FaUserTie, FaClock } from 'react-icons/fa';
